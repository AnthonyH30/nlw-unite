    ...
    return(
        <div className="flex flex-col gap-4">
            <div className="flex gap-3 items-center">
                ...
                <div className="px-3 py-1.5 border border-white/10 rounded-lg flex items-center gap-3">
                    <Search className="size-4 text-emerald-300" />
                    <input placeholder="Buscar participante..." className="bg-transparent flex-1 outline-none border-0 p-0 text-sm" type="text" />
                </div>
            </div>
                            ...
                            return(
                                ...
                                <td className="py-3 px-4 text-sm text-zinc-300">
                                    <div className="flex flex-col gap-1">
                                        <span className="font-semibold text-white">Anthony Harisson</span>
                                        <span>AnthonyHarisson@gmail.com</span>
                                    </div>
                                </td>
